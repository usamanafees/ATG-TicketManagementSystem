        ...
        if report_id in reportdict:
            if report_id == 'IssuesPriority':
                ...
                for user in user_labour_hours:
                    ...
                    full_name = user['note_ticket__ticket_caller__first_name'] + " , " + user['note_ticket__ticket_caller__last_name']
        ...
        try:
            if len(filter_statement[key]) == 1:
                if filter_statement[key] == '(':
                    ...
                    argument_list.append(getCompoundFilterForQuery(remain_filter_statement, filter_expression_array, conditiondict))
...
# Clone Query From Query Builder StartEnd #
